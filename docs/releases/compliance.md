...
- historical commits without DCO trailers have been reviewed under
  `docs/governance/historical-contributions.md` without rewriting published history;
...
The finalization review includes `.github/README.md`, `.github/SECURITY.md`,
`docs/index.md`, `docs/releases/changelog.md`, `docs/legal/changelog.md`,
`docs/releases/release-keys.md`, `docs/legal/source-availability.md`,
`docs/legal/privacy.md`, `docs/releases/verification.md`, this file, both
installation guides, `docs/guides/fleet-setup.md`,
`docs/releases/releasing.md`, and the beta release notes. Remove
