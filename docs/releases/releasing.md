...
1. Run `scripts/verify-repository-layout.py` and resolve every tracked-file
   provenance classification.
2. Confirm contributor and chain-of-title records privately.
3. Update `docs/releases/changelog.md`, the legal changelog, and release notes.
...
6. Provision the separate provenance and Debian-attestation keys under
   [release key policy](release-keys.md), and publish the full release OpenPGP
...
7. After every gate passes, perform the final candidate-status flip before
   ...
   preparation, and unreleased status for this version in `.github/README.md`,
   `docs/releases/changelog.md`, `docs/legal/changelog.md`, `docs/index.md`,
   both installation guides, this guide, `docs/releases/release-keys.md`,
   `docs/legal/source-availability.md`, `docs/releases/verification.md`,
   `docs/releases/compliance.md`, `docs/guides/fleet-setup.md`, and the beta
   release notes.
...
STATUS_FILES=(
  .github/README.md .github/SECURITY.md
  docs/index.md docs/guides/install-macos.md docs/guides/install-debian.md
  docs/guides/fleet-setup.md docs/legal/changelog.md docs/legal/privacy.md
  docs/legal/source-availability.md docs/releases/changelog.md
  docs/releases/compliance.md docs/releases/release-keys.md
  docs/releases/release-notes-v1.0.0-beta.1.md
  docs/releases/releasing.md docs/releases/verification.md
)
...
if rg -n --fixed-strings \
  ...
  .github/SECURITY.md; then
  echo 'security support status finalization is incomplete' >&2
  exit 1
fi
for dated in docs/releases/changelog.md docs/legal/changelog.md \
  docs/releases/release-notes-v1.0.0-beta.1.md; do
...
cp docs/releases/release-notes-v1.0.0-beta.1.md "$RELEASE_BODY"
printf '%s\n' \
  '' \
  '## Exact-tag documentation' \
  '' \
  '- [Migration](https://github.com/magrathean-uk/teslatlas-hub/blob/v1.0.0-beta.1/docs/releases/migration.md)' \
  '- [Legal changelog](https://github.com/magrathean-uk/teslatlas-hub/blob/v1.0.0-beta.1/docs/legal/changelog.md)' \
  >>"$RELEASE_BODY"
...
gh release view "$TAG" --repo magrathean-uk/teslatlas-hub \
  --json body --jq .body |
  rg -q --fixed-strings \
    'github.com/magrathean-uk/teslatlas-hub/blob/v1.0.0-beta.1/docs/releases/migration.md'
gh release view "$TAG" --repo magrathean-uk/teslatlas-hub \
  --json body --jq .body |
  rg -q --fixed-strings \
    'github.com/magrathean-uk/teslatlas-hub/blob/v1.0.0-beta.1/docs/legal/changelog.md'
