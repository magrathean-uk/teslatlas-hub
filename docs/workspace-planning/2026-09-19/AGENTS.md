...
Current owner reset: 2026-09-18. Read `WORKSPACE_AUTHORITY.md`, then
`docs/development/MASTER_PLAN.md` and your product's `docs/development/PLAN.md`.
The current objective is a working Hub ecosystem ready for the App owner's v7
adoption work. Do not inspect, edit, build, test, clean or delegate work in `app/`.
...
unchanged suites or poll inactive tasks. No commit, push, CI, release or production actions.
