...
2026-09-19: the bounded adoption milestone and secondary HA Container lifecycle are
accepted. The roles and behavioral requirements below remain the specification.
Remaining installed lifecycle and package work is drafted in
[NEXT_PHASE_PLAN.md](NEXT_PHASE_PLAN.md); no new campaign is started here.
