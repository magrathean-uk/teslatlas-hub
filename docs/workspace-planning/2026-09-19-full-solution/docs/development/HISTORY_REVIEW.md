...
The owner then clarified: "i want to compelte this, not just v7 readiness, but a fully working solution along all deps too."
The earlier L1–L3-only goal was too narrow. The current master and prompt require
F0–F7 and all six products, including HA and input-dependent real-data/parity evidence.
Earlier accepted milestones stay accepted but do not complete the full programme.
This expands the written goal; the instruction not to send/start it remains active.
