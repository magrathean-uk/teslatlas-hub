...
This accepted handoff is an intermediate milestone. It does not complete the broader
Hub ecosystem programme; all six active products and F0–F7 in
[MASTER_PLAN.md](MASTER_PLAN.md) are required for full-solution acceptance.

Planning reconciliation on 2026-09-19 preserves this handoff. The source identities
below name the original tested dirty-tree cohorts, not automatically later upload
commit HEADs. Publication is tracked separately in [UPLOAD_STATUS.json](UPLOAD_STATUS.json)
without rewriting historical acceptance receipts.
...
the App, or any deferred product. Home Assistant has separate bounded Container
lifecycle acceptance in its [2026-09-19 receipt](../../teslatlas-home-assistant/docs/development/ha-debian-arm64-container-lifecycle-acceptance-2026-09-19-r1.json);
that does not broaden this handoff's scope.
