...
see [CLI reference](CLI.md#platform-invocation).
...
using the path in [CLI reference](CLI.md#platform-invocation).
...
6. report a product vulnerability privately under [SECURITY.md](../SECURITY.md).
