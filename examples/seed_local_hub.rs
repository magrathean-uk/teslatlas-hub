...
use teslatlas_hub::{
    ...
    hub_pack::{
        ProjectionBinding, ProjectionCar, ProjectionCarSettings, ProjectionDrive,
        ProjectionPackRequest, ProjectionPackWriter, ProjectionPosition, ProjectionSnapshot,
    },
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let snapshot = ProjectionSnapshot {
        cars: vec![ProjectionCar {
            ...
            marketing_name: Some("LR AWD".to_owned()),
            exterior_color: Some("Pearl White".to_owned()),
            wheel_type: Some("Aero".to_owned()),
            spoiler_type: None,
        ...
        drives: vec![ProjectionDrive {
            ...
            power_max: Some(12.0),
            power_min: Some(0.0),
            start_ideal_range_km: Some(300.0),
            end_ideal_range_km: Some(294.0),
            start_address: None,
            end_address: None,
            start_geofence: None,
            end_geofence: None,
        ...
        positions: vec![
            ProjectionPosition {
                ...
                est_battery_range_km: Some(325.0),
                ...
                tpms_pressure_fl: Some(2.9),
                tpms_pressure_fr: Some(2.9),
                tpms_pressure_rl: Some(2.8),
                tpms_pressure_rr: Some(2.8),
            },
            ProjectionPosition {
                id: 2,
                drive_id: Some(1),
                ...
                ideal_battery_range_km: None,
                est_battery_range_km: Some(319.0),
