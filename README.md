...
<p align="center">
  ...
  <a href="docs/FLEET_SETUP.md">Fleet setup</a> ·
  <a href="MIGRATION.md">TeslaMate migration</a> ·
...
before installation; see [Verify a release](RELEASE_VERIFICATION.md).
...
[Install on Debian](docs/INSTALL_DEBIAN.md).
...
source-checkout invocation in [CLI reference](docs/CLI.md#platform-invocation).
...
[Backup and recovery](docs/BACKUP_RECOVERY.md), and
...
- Review deployment responsibilities in [PRIVACY.md](PRIVACY.md).
- Review safety boundaries in [SAFETY_AND_USE_LIMITS.md](SAFETY_AND_USE_LIMITS.md).
...
[ADDITIONAL_TERMS.md](ADDITIONAL_TERMS.md). Third-party material remains under
its identified licence. See [Legal framework](LEGAL.md),
[Licensing](LICENSING.md), [Notices](NOTICE), and
